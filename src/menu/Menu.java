            ...
            do{ //This do while is for number of passenger and <= 10 person
                    try{
                        switch(seatTypeOneChar)
                        {
                            ...
                            case 'E': 
                            {
                                Economy eco1 = new Economy("Economy", 0); //for create economy object only to run next line method
                                eco1.howToInput();
                                break;
                            }
                             case 'b':
                             ...
                             {
                                Business bus1 = new Business("Business", 0); //for create business object only to run next line method
                                bus1.howToInput();
                                break; 
                            }
                        }
